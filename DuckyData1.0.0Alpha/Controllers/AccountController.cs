...
"<b> zhuzhaohu.daniel@gmail.com </b><br><br>To activate your account,please click the below<br><br> This message comes from an unmonitored mailbox.Please do not reply to this message.<br><br>"+
"</td></tr>"+
"<tr><td><a href=\"https://accounts.google.com\" style=font-family:Roboto-Regular,Helvetica,Arial,sans-serif;display:inline-block;text-align:center;text-decoration:none !important;min-height:36px;line-height:36px;padding:8px;min-width:88px;font-size:14px;font-weight:400;color:#ffffff;background-color:#4184f3;border-radius:2px;border-width:0px; target=\"_blank\"><span width=200px style=padding:8px;color:#FFFFFF;background-color:#4184f3;width:200px;max-width-200px>ACTIVATE YOUR ACCOUNT</span></a></td></tr>" +
